...
FString UAuraGameplayAbility::GetDescription(int32 Level)
{
	return FString::Printf(
		...
		L"Default Ability Name - LoremIpsum LoremIpsum LoremIpsum LoremIpsum LoremIpsum LoremIpsum LoremIpsum "
...
{
	return FString::Printf(
		TEXT("<Default>Spell Locked Until Level: </><Level>%d</>"), Level);
}
