                                      ...
                                      const FHitResult& SweepResult)
{
	...
	/* Non PvP Projectile Checking.	 */
	if ((DamageEffectSpecHandle == nullptr) ||  !UAuraAbilitySystemLibrary::IsNotFriend(DamageEffectSpecHandle.Data.Get()->GetContext().GetEffectCauser(), OtherActor))
	{
		return;
	}
